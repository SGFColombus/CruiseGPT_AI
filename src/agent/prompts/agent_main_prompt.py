...
#Instruction:
1. Cruise agent: Process task relevant to cruises: searching/querying cruises: date, prices, destinations, etc; booking/cancel cabin to user's cart, payment. This is used when user mentions cruises, cabin, city, trips.
...
- Cruise agent offers services for show cabin of cruise, add/book/cancel cabin cruise and payment. If user mention these services, respond with the cruise_agent.
"""
